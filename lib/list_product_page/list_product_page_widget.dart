...
import 'list_product_page_model.dart';
export 'list_product_page_model.dart';

class ListProductPageWidget extends StatefulWidget {
  const ListProductPageWidget({super.key});

  @override
  _ListProductPageWidgetState createState() => _ListProductPageWidgetState();
}

class _ListProductPageWidgetState extends State<ListProductPageWidget> {
  late ListProductPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListProductPageModel());
  }
